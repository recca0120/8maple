...
if __name__ == '__main__':
    ...
    # asyncio.run(main('神偷奶爸4', 'https://gimy.ai/eps/282890-1-1.html'))
    # asyncio.run(main('我的世界大電影', 'https://gimy.ai/eps/314981-2-1.html'))
    # asyncio.run(main('阿甘正傳', 'https://gimy.ai/eps/191756-4-1.html'))
    # asyncio.run(main('命運石之門', 'https://gimytv.biz/video/3706-1.html#sid=1'))
    asyncio.run(main('命運石之門第二季', 'https://gimytv.biz/video/3703-1.html#sid=1'))
